...
| [0.28.0](https://github.com/dgahagan/shelf/releases/tag/v0.28.0) | One validation stage in front of every write, so a bad ISBN is refused the same way everywhere |
